...
def main():
    ...
    st.sidebar.success(" email spam detection using machine learning offers a promising solution to the pervasive problem of unwanted and harmful emails.")
    st.markdown("check whether email is ham or spam")
